...
const (
	errCompare = "Expected %s, got %s"
)

func TestCryptoEncodeSHA1HMACBase64(t *testing.T) {
	...
	if result != expectedValue {
		t.Errorf(errCompare, expectedValue, result)
	}
}

func TestCryptoEncodeSHA256HMAC(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeSHA512HMACBase64(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeMD5(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeMD5Base64(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeBASE64(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoDecodeBASE64(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
	...
	if result != "text" {
		t.Errorf(errCompare, "text", result)
	}
}

func TestCryptoEncodeBASE64URL(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeSHA256(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
...
func TestCryptoEncodeSHA512(t *testing.T) {
	c := encryptions.NewCrypto("secretKey")
